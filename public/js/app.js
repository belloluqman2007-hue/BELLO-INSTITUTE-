...
/* BELLO public platform application & client router */
(function () {
    ...
    app.innerHTML = `
      <header class="site-header" id="home">
        <div class="nav-shell">
          ...
          <div class="nav-actions">
            ...
            <a class="button button-small" href="/register-madrasa" data-route="/register-madrasa">Get Started <span>${icons.arrow}</span></a>
          </div>
        ...
        <nav class="mobile-nav" id="mobile-menu" aria-label="Mobile navigation" aria-hidden="true">
          ...
          <a class="button" href="/register-madrasa" data-route="/register-madrasa">Register Your Madrasa <span>${icons.arrow}</span></a>
        </nav>
      </header>
      ...
      <main id="main-content">
          ...
          <div class="container hero-grid">
            <div class="hero-content reveal">
              ...
              <div class="hero-actions">
                ...
                <a class="button button-secondary" href="/register-madrasa" data-route="/register-madrasa">Register Your Madrasa</a>
              </div>
        ...
        <section class="section madrasas-section section-pattern-light" id="madrasas" aria-labelledby="madrasas-title">
          <div class="container">
            ...
            <div class="all-link-wrap reveal"><a class="button button-outline" href="/register-madrasa" data-route="/register-madrasa">Register Your Madrasa <span>${icons.arrow}</span></a></div>
          </div>
        </section>
        ...
        <section class="section admin-section" id="administrators" aria-labelledby="admin-title">
          <div class="container admin-layout">
            ...
            <div class="admin-copy reveal reveal-delay">
              ...
              <a class="button button-gold" href="/register-madrasa" data-route="/register-madrasa">Register Your Madrasa <span>${icons.arrow}</span></a>
            </div>
          </div>
        </section>
        ...
        <section class="final-cta" aria-labelledby="cta-title">
          ...
          <div class="container cta-content reveal">
            ...
            <div class="cta-actions"><a class="button button-gold" href="#madrasas">Find a Madrasa <span>${icons.arrow}</span></a><a class="button button-ghost" href="/register-madrasa" data-route="/register-madrasa">Register Your Madrasa</a></div>
          </div>
        </section>
      </main>
      ...
      <footer class="site-footer" id="footer">
        <div class="container footer-grid">
          ...
          <div class="footer-col"><h3>For Madrasas</h3><a href="/register-madrasa" data-route="/register-madrasa">Register Your Madrasa</a><a href="/register-madrasa" data-route="/register-madrasa">Administration</a></div>
  ...
  function initHomepageEvents() {
    ...
    // Attach client-side routing to [data-route] links
  ...
  window.App = {
    mount: () => renderRoute(),
    routeTo: async (path) => window.BelloRouter.navigate("/" + path.replace(/^\//, "")),
