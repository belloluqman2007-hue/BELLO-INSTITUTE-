...
(function () {
  ...
  async function renderSchoolPublic(slug) {
    ...
    try {
      ...
      app.innerHTML = `${schoolHeaderMarkup(m)}<main id="main-content" class="school-public${look.website_theme === "dark" ? " school-theme-dark" : ""}" style="${styleVars}">${navMarkup}
